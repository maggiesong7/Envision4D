...
from ..encoder_envision4d import EncoderEnvi4D
# from ..epipolar.epipolar_sampler import EpipolarSampling
from .encoder_visualizer import EncoderVisualizer
from .encoder_visualizer_envision4d_cfg import EncoderVisualizerEnvi4DCfg
...
class EncoderVisualizerEnvi4D(
    EncoderVisualizer[EncoderVisualizerEnvi4DCfg, EncoderEnvi4D]
):
    def visualize(
        self,
